...
<body>
  ...
  <div class="login-container">
    ...
    <form action="Next.jsp" method="post" name="">
      <label for="firastName" class="form-label">Enter FirstName:</label>
      <input type="text" name="firastName" id="firastName" class="form-control" placeholder="Enter your firstName">
